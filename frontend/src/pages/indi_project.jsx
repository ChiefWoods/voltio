    ...
    <BackgroundImage>
      ...
      <div className='mt-[50px] mb-[100px]'>
        <div className='flex flex-row mb-10 items-center align-center place-content-center'>
          ...
          <img className='mx-6 rounded-lg' src={solar_panel1} alt="Project" />
          <div className='flex items-center cursor-pointer'>
          ...
          <div className='flex flex-row justify-between'>
            <div className='bg-dg w-[70%] p-6 rounded-2xl'>
              ...
              <p className='text-[18px] mt-4 ml-2'>
                Solar farm located in Pahang, Malaysia. Sitting in a land at about 80 acres in size. Rate of energy generated is exceptionally stable.
              </p>
              <button 
