                                        ...
                                        <table className='w-[100%]'>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td className='text-center text-white font-semibold py-4'>Project D</td>
                                                    <td className='text-center text-white font-semibold py-4'>982</td>
                                                    <td className='text-center text-white font-semibold py-4'>2/6/2024</td>
                                                    <td className='text-center text-white font-semibold py-4'><button className='bg-[#AF3BE0] rounded-3xl px-4 py-2 hover:scale-110'>Sell</button></td>
                                                </tr>
